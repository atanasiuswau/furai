...
add_theme_support('foundation-top-bar');    // Enable Foundation's top bar
// add_theme_support('foundation-gallery');     // Enable Foundation's Clearing Lightbox component on [gallery]
